...
import 'package:bottom/ui/meat_detail_screen.dart';
import 'package:bottom/ui/work_out.dart';
        ...
        child: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
                ...
                title: Text("Home",style: const TextStyle(color: Colors.black),)
            ),
            BottomNavigationBarItem(
              icon: Padding(
                padding: const EdgeInsets.all(8.0),
                ...
                // ignore: deprecated_member_use
                title: Text("Search",style: const TextStyle(color: Colors.black),)
            ),
            BottomNavigationBarItem(
              icon: Padding(
                padding: const EdgeInsets.all(8.0),
